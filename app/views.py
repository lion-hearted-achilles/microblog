...
@app.errorhandler(500)
      ...
      # if error triggered by database error, database session will arrive in inavlid state
      # so, roll it back in case we need a working session for rendering template
      db.session.rollback()
